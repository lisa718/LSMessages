#
#  Be sure to run `pod spec lint LSMessages.podspec' to ensure this is a
...
There are 4 different types already set up for you: Success, Error, Warning, Message.
  ...
  s.license      = "Lisa"
  # s.license      = { :type => "Lisa", :file => "FILE_LICENSE" }
  ...
  s.author             = { "lisa" => "164049933@qq.com" }
  # Or just: s.author    = "lisa"
  # s.authors            = { "lisa" => "164049933@qq.com" }
  ...
  s.source       = { :git => "git@github.com:lisa718/LSMessages.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ForPod/Classes", "Classes/**/*.{h,m}"
